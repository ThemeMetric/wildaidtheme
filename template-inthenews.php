<?php
/**
  * Template Name: In the News Template
 */
get_header(); 
$id=get_the_id();

$news_image = wp_get_attachment_image_src( get_post_thumbnail_id(69), 'full');
$placeHolder= __("Search WildAid in the News");
?>
...
?>
    ...
    <div class="flex search-container" >
        ...
        <form action="<?php echo site_url();?>/resource" id="newssearch"  method="POST">
            ...
            <input type="hidden" name="searchcat" id="hiddenSearchCat" value="<?php print $cat; ?>" />
...
<main>
	...
	H39.5z"/>
            ...
            <div class="text-center view-more-news">
                <a href="/resource/?searchtype=news" class="btn btn-link">VIEW MORE NEWS</a>
            </div>
        </div>
    </div>
